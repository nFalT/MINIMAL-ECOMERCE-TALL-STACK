    ...
    @if($hasProducts)
        ...
        <div class="mb-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col">
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        <div class="flex-grow">
                            <h3 class="font-medium text-gray-800 text-lg mb-2 line-clamp-2">{{ $product->name }}</h3>
                        ...
                        <div class="flex items-center justify-between mt-auto">
                            ...
                            <button wire:click="$dispatch('add-to-cart', { productId: {{ $product->id }}})" class="text-white bg-blue-600 hover:bg-blue-700 rounded-full p-1.5 focus:outline-none focus:ring-2 focus:ring-blue-400">
        ...
        <div class="mb-12">
            <div class="flex justify-between items-center mb-6 pb-2 border-b">
                ...
                <a wire:navigate href="/all/products?category={{ $category->id }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center group">
                    View All
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block ml-1 transition-transform duration-200 group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
    ...
    @else
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            <div class="p-8 md:p-12 text-center">
                ...
                <a href="/all/products" class="inline-flex items-center justify-center px-5 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors">
                    Browse Categories
                </a>
            </div>
        </div>
