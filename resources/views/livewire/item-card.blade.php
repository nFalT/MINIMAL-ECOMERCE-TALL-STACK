<div class="bg-gray-100 shadow-sm rounded-lg hover:border border-blue-400 p-1">
    <a href="/product/details">
        <div>
            <img src="{{ asset('images/2.jpg') }}" alt="product-images" class="rounded-t-lg object-cover w-full h-[180px]"
                width="400px">
        </div>
        <div>
            <h2 class="line-clamp-2 px-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti dolorum nisi, odio totam
