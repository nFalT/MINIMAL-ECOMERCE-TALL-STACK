        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full group">
                <a wire:navigate href="/product/{{ $product->id }}/details" class="block relative h-48 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black/20 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    ...
                    @endif
                    <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-4 text-white translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-10">
                ...
                <div class="p-4 flex flex-col flex-grow">
                    ...
                    <div class="flex items-center justify-between mt-auto">
                        ...
                        <button wire:click="addToCart({{ $product->id }})" class="text-white bg-blue-600 hover:bg-blue-700 rounded-full p-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-300 hover:scale-110 relative overflow-hidden group">
                            <span class="absolute inset-0 bg-white rounded-full scale-0 group-hover:scale-100 transition-transform origin-center duration-300 opacity-20"></span>
    ...
    @else
        <div class="bg-gray-50 rounded-lg border border-gray-100 p-8 mb-8">
            <div class="flex items-center justify-center flex-col text-center">
                ...
                <p class="text-gray-600 mb-6">We're working on adding amazing products to this category. Check back soon!</p>
                <a href="/all/products" class="inline-flex items-center justify-center px-5 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105">
